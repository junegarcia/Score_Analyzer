...
Main entry point – handles login and page routing.
"""
...
from utils.database import authenticate_user, seed_database, check_connection
...
def render_login():
    if not db_ok:
        ...
        <div style="max-width:480px;margin:4rem auto;background:#FEE2E2;border:1px solid #FECACA;
            ...
            <code style="background:#FEF2F2;padding:.2rem .5rem;border-radius:6px;">mongod --dbpath /data/db</code>
            </p>
        </div>
            ...
            if submitted:
                if not username or not password:
                    ...
                    if user:
                        ...
                        st.session_state.user_id     = str(user.get("student_id") or user.get("teacher_id") or user.get("_id"))
