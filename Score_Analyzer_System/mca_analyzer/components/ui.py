...
/* Make sure the open/close arrow is always reachable, even though the
   rest of the header chrome (menu, deploy button) is hidden above. */
[data-testid="collapsedControl"] {
    visibility: visible !important;
    display: flex !important;
    z-index: 999999 !important;
}
/* Hide Streamlit's auto-generated page list (built from files in pages/) —
   the app renders its own role-based nav buttons instead. */
