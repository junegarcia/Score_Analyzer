...
def render_db_error():
    st.markdown(f"""
    <div style="max-width:480px;margin:4rem auto;background:#FEE2E2;border:1px solid #FECACA;
                border-radius:16px;padding:2rem;text-align:center;">
        <div style="font-size:3rem;">⚠️</div>
        <h2 style="color:#991B1B;">Database Connection Failed</h2>
        <p style="color:#7F1D1D;font-size:.9rem;">{db_msg}</p>
        <p style="color:#7F1D1D;font-size:.85rem;margin-top:1rem;">
        Check that the Oracle listener is reachable and that <code style="background:#FEF2F2;padding:.15rem .4rem;border-radius:6px;">ORACLE_HOST</code>,
        <code style="background:#FEF2F2;padding:.15rem .4rem;border-radius:6px;">ORACLE_PORT</code>,
        <code style="background:#FEF2F2;padding:.15rem .4rem;border-radius:6px;">ORACLE_SERVICE</code>,
        <code style="background:#FEF2F2;padding:.15rem .4rem;border-radius:6px;">ORACLE_USER</code> and
        <code style="background:#FEF2F2;padding:.15rem .4rem;border-radius:6px;">ORACLE_PASSWORD</code> are set correctly.<br>
        Quick check from a terminal:<br>
        <code style="background:#FEF2F2;padding:.2rem .5rem;border-radius:6px;">sqlplus user/pass@host:port/service</code>
        </p>
    </div>
    ...
    with col2:
        ...
        <div class="login-container">
            <div class="login-logo">
                ...
                <h1>MCA Score Analyzer</h1>
                <p>Master of Computer Applications · Score Management System</p>
            </div>
        </div>
        """, unsafe_allow_html=True)
        ...
        <div style="margin-top:1rem;padding:1rem;background:#F8FAFC;border-radius:12px;
                    border:1px solid #E2E8F0;font-size:.82rem;color:#64748B;">
            <b style="color:#1E3A8A;">Demo Credentials</b><br><br>
            🎓 <b>Student:</b> aarav1001 / pass1001<br>
            👩‍🏫 <b>Teacher:</b> t_anand / tpass1<br>
    ...
    with col2:
        ...
        <div class="login-container">
            <div class="login-logo">
                ...
                <p>Register to access your marks, analytics, and rank</p>
            </div>
        </div>
        """, unsafe_allow_html=True)
